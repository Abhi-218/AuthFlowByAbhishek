...
export default function ForgetPasswordPage() {
  ...
  useEffect(() => {
    if (user.email.length > 0 && user.password.length > 0 && emailChecked) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-700 flex justify-center items-center p-4 mt-10">
      <motion.div
        initial="hidden"
        animate="visible"
      ...
      >
        ...
        >
          ...
          <form onSubmit={resetPassword} className="p-8">
            <div className="space-y-5">
              ...
              >
                ...
                <motion.input
                  ...
                  value={user.email}
                  className="w-full bg-slate-700/50 text-white pl-10 outline-none pr-3 py-3 rounded-l-lg focus:outline-none border border-slate-600  transition-all"
                  required
              ...
              {codeRequested && (
                ...
                >
                  ...
                  <motion.input
                    ...
                    className="w-full bg-slate-700/50 text-white px-10 py-3 outline-none rounded-lg focus:outline-none border border-slate-600 focus:border-blue-500 transition-all"
                    required
